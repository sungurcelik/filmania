...
const Card = ({ movie }) => {
  ...
  return (
    <Link
      to={`/movie/${movie.id}`}
      className="border shadow p-3 rounded-md hover:shadow-lg cursor-pointer transition flex flex-col max-sm:flex-row mx-sm:gap-5"
    >
      <div className="relative mr-0 max-sm:mr-3">
        <img
        ...
        >
          {/* Tek basamaklı ratingleri çift basamağa çevirmek için. */}
